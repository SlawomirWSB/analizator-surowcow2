...
# --- KONFIGURACJA ---
st.set_page_config(page_title="Skaner PRO V6.9 - Poprawna Cena", layout="wide")
...
def analizuj(df, kapital_pln, tryb_wejscia):
    try:
        ...
        # POPRAWKA CENY WEJŚCIA
        wejscie = c if tryb_wejscia == "Rynkowa" else e
        ...
        return {
            ...
            "Cena Wejścia": round(wejscie, 4), # Wyraźna kolumna
            "RSI": round(r, 1), 
